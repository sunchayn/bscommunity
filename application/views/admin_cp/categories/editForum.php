            ...
            <div class="flexbox">
                ...
                <div class="col-m col-10 cp-display no-margin breads">
                    <div class="col-m col-12">
                        ...
                        <i class="icon-angle-<?=DIRECTION;?>"></i>
                        <a href="#edit-forum" class="disabled"><?=language::invokeOutput('breads/editForum');?></a>
                    </div>
                    <div class="col-m col-12 content-wrapper">
                        <form action="ajax/updateForum" method="POST" class="ajax noScroll">
                            ...
                            <div class="col-m col-12 box">
                                ...
                                <div class="col-m col-12">
                                    <input type="text" name="title_ar" placeholder="<?=Language::invokeOutput('addForum/placeholder1');?>" value="<?=$data['forum']->title_ar;?>" class="rad2" tabindex="1"/>
                                </div>
                            </div>
                            <div class="col-m col-12 box">
                                <div class="col-m col-12 box">
                                ...
                                <div class="col-m col-12">
                                    <input type="text" name="title_en" placeholder="<?=Language::invokeOutput('addForum/placeholder1-1');?>" value="<?=$data['forum']->title_en;?>" class="rad2" tabindex="1"/>
                                </div>
                            </div>
                            <div class="col-m col-12 box">
                                <div class="col-m col-12 box">
                                ...
                                <div class="col-m col-12">
                                    <input type="text" name="logo" placeholder="<?=Language::invokeOutput('addForum/placeholder3');?>" value="<?=$data['forum']->logo;?>" class="rad2 col-8" tabindex="2"/>
                                </div>
                            </div>
                            <div class="col-m col-12 box">
                                <div class="col-m col-12 box">
                                ...
                                <div class="col-m col-12">
                                    <textarea name="desc_ar" class='col-12' rows="6" placeholder="<?=Language::invokeOutput('addForum/placeholder2');?>" tabindex="3"><?=$data['forum']->desc_ar;?></textarea>
                                </div>
                            </div>
                            <div class="col-m col-12 box">
                                <div class="col-m col-12 box">
                                ...
                                <div class="col-m col-12">
                                    <textarea name="desc_en" class='col-12' rows="6" placeholder="<?=Language::invokeOutput('addForum/placeholder2-2');?>" tabindex="3"><?=$data['forum']->desc_en;?></textarea>
                                </div>
                            </div>
                            <div class="col-m col-12 login-label">
                                ...
                                <input type="hidden" name="id" value="<?=$data['forum']->id;?>" />
