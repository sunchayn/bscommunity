            ...
            <div class="flexbox">
                ...
                <div class="col-m col-10 cp-display no-margin breads">
                    <div class="col-m col-12">
                        ...
                        <i class="icon-angle-<?=DIRECTION;?>"></i>
                        <a href="#whiteList" class="disabled"><?=language::invokeOutput('breads/blacklist');?></a>
                    </div>
                    <div class="col-m col-12 content-wrapper">
                        <div class="col-m col-12">
                            <h4><?=Language::invokeOutput('addBlack');?></h4>
                        </div>
                        <div class="col-m col-12">
                            <form action="ajax/addBlackURL" method="POST" class="ajax noScroll">
                    ...
                    <div class="col-m col-12 url-wrapper">
                            ...
                            <!-- #### -->
                            <?php
                            if (!empty($data['blackURL']))
                            {
                                foreach($data['blackURL'] as $url)
                                include('_URL.php');
                            }else{
