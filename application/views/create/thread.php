<div class="page newThreadReply-page">
    <div class="area sub-wrapper">
        <div class="grid-section">
            ...
            <form action="ajax/createThread" method="POST" class="ajax">
                ...
                <div class="col-m col-12 box">
                    <input type="text" name="keywords" class="col-8" placeholder="<?=Language::invokeOutput('placeholder/keywords')?>"><br />
                    <small>
                ...
                <div class="col-m col-12 box">
                    ...
                    <a id="submit-editor" href="#addThread" class="formSubmit"><?=Language::invokeOutput('submit/thread')?></a>&nbsp;<i class="icon-<?=DIRECTION;?>"></i>
                </div>
            </form>
